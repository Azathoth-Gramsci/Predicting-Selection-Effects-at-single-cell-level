...
class Manager:
    ...
    def __init__(self, use_wago_only=False, virtual_mode=False):
        self.use_wago_only = use_wago_only
        self.virtual_mode = virtual_mode
        self.start_log()
        if not self.virtual_mode:
            self.device = Device(use_wago_only=self.use_wago_only)
