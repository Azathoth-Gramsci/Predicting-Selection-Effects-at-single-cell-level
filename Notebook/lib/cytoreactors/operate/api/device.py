...
turbi_arduino_addresses = {1:'COM17', 2:'COM15', 3:'COM18', 4:'COM13'}
leds_address = 'http://localhost:5000'
ot2_address = 'http://169.254.6.20:5000'
guava_address = 'http://157.99.244.170:5000'

# the class representing the device object
class Device:

    def __init__(self, use_wago_only=False, connect_at_creation=True):
    ...
    def guava_request(self, endpoint):
        return requests.get(f'{guava_address}/{endpoint}').content.decode()
